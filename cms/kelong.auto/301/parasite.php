    ...
    <div class="card">
        ...
        <form id="settingsForm">
            ...
            <div class="form-group">
                ...
                <input type="text" name="source_path" class="form-input" value="<?php echo htmlspecialchars($task['source_path']); ?>" placeholder="/xiaoshuo/">
                <p class="form-hint">要监听的目录路径，如 /xiaoshuo/</p>
            </div>
            ...
            <div class="form-row">
                <div class="form-group" id="pathModeGroup" style="<?php echo $task['redirect_mode'] === 'interlink' ? 'display:none;' : ''; ?>">
...
function toggleModeOptions() {
    ...
    if (pathModeGroup) {
        pathModeGroup.style.display = mode === 'interlink' ? 'none' : '';
    }
    if (interlinkNotice) {
