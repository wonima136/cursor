...
<div class="d-flex justify-content-end mb-3 gap-2">
  <a href="/domains/edit.php?id=<?= $id ?>" class="btn btn-primary btn-sm"><i class="bi bi-pencil"></i> 编辑</a>
  <a href="/domains/" class="btn btn-outline-secondary btn-sm"><i class="bi bi-arrow-left"></i> 返回</a>
</div>
<div class="row g-3">
  <div class="col-xl-4">
    <div class="form-card">
