...
<div id="tab-paste" style="<?= $activeTab === 'paste' ? '' : 'display:none' ?>">
  <div class="form-card mb-3">
    <div class="section-title">格式说明（按列顺序）</div>
    <p class="text-muted small mb-2">每行一个域名，列之间用逗号或 Tab 分隔：</p>
    <div class="table-responsive">
      <table class="table table-sm table-bordered small">
        <thead><tr>
          <th>列1（必填）</th><th>列2</th><th>列3</th><th>列4</th><th>列5</th><th>列6</th><th>列7</th>
        </tr></thead>
        <tbody><tr>
          <td>域名</td><td>注册时间</td><td>过期时间</td><td>状态</td><td>备案</td><td>DNS</td><td>分组</td>
        </tr></tbody>
      </table>
    </div>
    <p class="text-muted small mb-0">示例：<code>example.com,2024-01-01,2025-01-01,normal,none,ns1.dnsp.com,备用</code></p>
  </div>
